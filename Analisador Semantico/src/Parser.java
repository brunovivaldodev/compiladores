...
public class Parser {
    ...
    ArrayList<String> ErrosSintaticos = new ArrayList<String>();


    public void Gravar_ErrosSintaticos(String token) {
        ErrosSintaticos.add(token);
    }

    public void Listar_ErrosSintaticos() {
        for (String token : ErrosSintaticos) {
    ...
    void erroSintatico(String... tokensEsperados) {
        ...
        Gravar_ErrosSintaticos(mensagem);
    }
